...
export interface Lesson {
  ...
  title: string;
  emoji: string;
  themeColor: string; // Ex: nature, space, animals
  cards: LessonCard[];
  quiz: QuizQuestion[];
  badgeId: string;
  badgeName: string;
...
export interface Universe {
  ...
  emoji: string;
  description: string;
  themeColor: string; // Tailwind class base color (violet, green, etc.)
  lessons: Record<string, Lesson[]>; // Clé: '3-5', '6-8', '9-12'
}
          ...
          quiz: [
            {
              ...
              options: ["Le Lion 🦁", "Le Chat 🐱", "La Grenouille 🐸"],
              correctAnswer: "Le Chat 🐱"
            },
            {
              question: "Quel cri fait la petite grenouille dans l'eau ?",
              options: ["Roar ! 🦁", "Miaou ! 🐱", "Coââ ! 🐸"],
              correctAnswer: "Coââ ! 🐸"
            },
            {
              question: "Où vit le grand Lion sauvage ?",
              options: ["Dans la savane chaude 🦁", "Dans une baignoire 🛁", "Dans un placard 🚪"],
          ...
          quiz: [
            {
              ...
              options: ["La Girafe 🦒", "L'Éléphant 🐘", "Le Singe 🐒"],
              correctAnswer: "L'Éléphant 🐘"
            },
            {
              question: "Pourquoi la girafe a-t-elle un très long cou ?",
              options: ["Pour chanter plus fort 🎤", "Pour attraper les feuilles en haut des arbres 🌳", "Pour faire de la gymnastique 🤸"],
              correctAnswer: "Pour attraper les feuilles en haut des arbres 🌳"
            },
            {
              question: "Comment le singe se suspend-il aux branches ?",
              options: ["Avec ses ailes 🪶", "Avec ses bras agiles et sa queue 🐒", "Avec son nez 👃"],
      ...
      "6-8": [
        {
          ...
          quiz: [
            ...
            },
            {
              ...
              options: ["Des lunettes thermiques 😎", "Des protéines antigel spéciales ❄️", "Une bouillotte interne 🧼"],
            ...
            },
            {
              ...
              options: ["Elle peut cracher du feu 🔥", "Elle peut courir sur l'eau 🏃‍♂️", "Elle peut inverser son vieillissement pour renaître 🔄"],
          ...
          quiz: [
            {
              ...
              options: ["Jouer à cache-cache avec les humains 🙈", "Fuir le froid de l'hiver et trouver à manger ❄️🍎", "Visiter de grandes villes touristiques 🗼"],
            ...
            },
            {
              ...
              options: ["Du Canada jusqu'au Mexique 🦋", "De l'Afrique vers l'Asie 🗺️", "De la banquise au désert 🧊🐪"],
              correctAnswer: "Du Canada jusqu'au Mexique 🦋"
            },
            {
              question: "Où le saumon retourne-t-il pondre ses œufs à l'âge adulte ?",
              options: ["Dans le sable du désert 🐪", "Dans la rivière exacte où il est né 🐟", "Au fond des fosses marines 🌊"],
            ...
            },
            {
              ...
              options: ["Les courants d'air chaud 💨", "Le champ magnétique terrestre 🧲", "L'odeur des fleurs 🌸"],
          ...
          quiz: [
            {
              ...
              options: ["À nettoyer les fenêtres 🪟", "À arroser les plantes et la nature 🌿💧", "À refroidir le soleil ☀️"],
              correctAnswer: "À arroser les plantes et la nature 🌿💧"
            },
            {
              question: "Quel objet s'envole très bien dans le ciel quand il y a du vent ?",
              options: ["Un cerf-volant 🪁", "Une bicyclette 🚲", "Une peluche panda 🐼"],
          ...
          quiz: [
            {
              ...
              options: ["La condensation ☁️", "L'évaporation ☀️", "Les précipitations 🌧️"],
              correctAnswer: "L'évaporation ☀️"
            },
            {
              question: "Que se passe-t-il pendant la condensation ?",
              options: ["La vapeur d'eau forme des nuages ☁️", "La pluie tombe sur la terre 🌧️", "L'eau gèle en glace 🧊"],
              correctAnswer: "La vapeur d'eau forme des nuages ☁️"
            },
            {
              question: "Comment l'eau des nuages retourne-t-elle au sol ?",
              options: ["Par téléportation 🌀", "Par les précipitations (pluie, neige) 🌧️", "Elle ne retourne jamais 🚫"],
              correctAnswer: "Par les précipitations (pluie, neige) 🌧️"
            },
            {
              question: "Qu'est-ce qu'une nappe phréatique ?",
              options: ["Une rivière de lave sous la Terre 🌋", "Un grand réservoir d'eau souterrain naturel 💧", "Un nuage très bas ☁️"],
          ...
          quiz: [
            {
              ...
              options: ["La respiration cellulaire 🫁", "La photosynthèse 🍃", "La cristallisation 💎"],
              correctAnswer: "La photosynthèse 🍃"
            },
            {
              question: "À quoi sert principalement la chlorophylle dans les feuilles ?",
              options: ["À capter la lumière du soleil pour fabriquer de l'énergie ☀️", "À repousser les insectes gourmands 🐛", "À stocker l'eau de pluie 🌧️"],
            ...
            },
            {
              ...
              options: ["Du dioxyde de carbone (CO2) 🧪", "De l'oxygène (O2) 💨", "Du sucre en poudre 🍬"],
            ...
            },
            {
              ...
              options: ["Les stomates 🔍", "Les racines 🎋", "Les pétales 🌸"],
          ...
          quiz: [
            {
              ...
              options: ["La peau 👤", "Le squelette 🦴", "Les muscles 💪"],
              correctAnswer: "Le squelette 🦴"
            },
            {
              question: "Que se passerait-il si nous n'avions pas d'os ?",
              options: ["Nous pourrions voler 🦅", "Nous ne pourrions pas tenir debout et serions tout mous 🧸", "Nous serions bleus 🔵"],
            ...
            },
            {
              ...
              options: ["Le sucre des bonbons 🍬", "Le calcium du lait 🥛", "Le sel des frites 🍟"],
          ...
          quiz: [
            {
              ...
              options: ["Dans l'estomac 🥣", "Dans la bouche 👄", "Dans l'intestin grêle 🌀"],
              correctAnswer: "Dans la bouche 👄"
            },
            {
              question: "Quel organe utilise des acides pour dissoudre les aliments en bouillie ?",
              options: ["L'estomac 🧪", "Les poumons 🫁", "Le cœur ❤️"],
              correctAnswer: "L'estomac 🧪"
            },
            {
              question: "À quoi sert principalement l'intestin grêle ?",
              options: ["À fabriquer de l'air pour parler 🗣️", "À filtrer les nutriments pour les envoyer dans le sang 💪", "À stocker l'eau froide 🥤"],
            ...
            },
            {
              ...
              options: ["L'acide gastrique 🧪", "La bile 🧪", "La salive 👄"],
              correctAnswer: "La bile 🧪"
            },
            {
              question: "Qu'est-ce que le microbiote intestinal ?",
              options: ["De petites cellules musculaires 💪", "Des milliards de bonnes bactéries qui aident à digérer 🦠", "Des petits os dans l'intestin 🦴"],
          ...
          quiz: [
            {
              ...
              options: ["Le cœur ❤️", "Le cerveau 🧠", "L'estomac 🥣"],
            ...
            },
            {
              ...
              options: ["Les cheveux 💇", "Les os 🦴", "Les nerfs ⚡"],
              correctAnswer: "Les nerfs ⚡"
            },
            {
              question: "Que fait le cerveau pendant que tu es en train de dormir la nuit ?",
              options: ["Il s'éteint complètement comme un téléphone 📴", "Il trie les souvenirs de la journée et gère la mémoire 💤💾", "Il nettoie les oreilles 👂"],
            ...
            },
            {
              ...
              options: ["Les neurones et les synapses 🔬", "Les globules rouges et blancs 🩸", "Les muscles et les tendons 💪"],
            ...
            },
            {
              ...
              options: ["L'hémisphère droit 🎨", "L'hémisphère gauche 🔢", "L'hémisphère arrière 💤"],
          ...
          quiz: [
            {
              ...
              options: ["5 planètes 🛰️", "8 planètes 🪐", "12 planètes 🌌"],
              correctAnswer: "8 planètes 🪐"
            },
            {
              question: "Quelles sont les planètes rocheuses les plus proches du Soleil ?",
              options: ["Mercure, Vénus, Terre et Mars 🌍", "Jupiter, Saturne, Uranus et Neptune 🪐", "La Lune et le Soleil ☀️"],
          ...
          quiz: [
            {
              ...
              options: ["Dans des volcans spatiaux 🌋", "Dans des nuages de gaz appelés nébuleuses 🌌", "Au cœur des trous noirs 🕳️"],
              correctAnswer: "Dans des nuages de gaz appelés nébuleuses 🌌"
            },
            {
              question: "Quel âge a environ notre Soleil actuellement ?",
              options: ["2000 ans 🗓️", "4,5 milliards d'années ☀️", "90 milliards d'années 📅"],
              correctAnswer: "4,5 milliards d'années ☀️"
            },
            {
              question: "Pourquoi rien ne peut s'échapper d'un Trou Noir, pas même la lumière ?",
              options: ["Parce qu'il y fait trop noir 🌃", "Parce que sa force d'attraction (gravité) est incroyablement forte et dense 🕳️⚡", "Parce qu'il est fermé à clé 🔑"],
            ...
            },
            {
              ...
              options: ["La combustion classique 🔥", "La fusion nucléaire 🔬", "La photosynthèse stellaire 🍃"],
            ...
            },
            {
              ...
              options: ["Une comète filante ☄️", "Une supernova 💥", "Une éclipse totale 🌑"],
          ...
          quiz: [
            {
              ...
              options: ["1 canard 🦆", "2 canards 🦆🦆", "3 canards 🦆🦆🦆"],
              correctAnswer: "2 canards 🦆🦆"
            },
            {
              question: "Combien de pommes vois-tu ici ? 🍎 🍎 🍎",
              options: ["3 pommes 🍎", "1 pomme 🍎", "5 pommes 🍎"],
        ...
        },
        {
          ...
          quiz: [
            ...
            },
            {
              ...
              options: ["3 coins 🔺", "4 coins 🟦", "0 coin 🟡"],
      ...
      "6-8": [
        {
          ...
          quiz: [
            ...
            },
            {
              ...
              options: ["2 billes", "8 billes", "15 billes"],
            ...
            },
            {
              ...
              options: ["Ceux qui n'aiment rien 🚫", "Les éléments qui appartiennent aux deux groupes en même temps ⭕", "Le groupe le plus grand 📈"],
      ...
      "3-5": [
        {
          ...
          quiz: [
            ...
            },
            {
              ...
              options: ["À une boîte carrée 📦", "À un grand ballon rond 🏀", "À une étoile pointue ⭐"],
              correctAnswer: "À un grand ballon rond 🏀"
            },
            {
              question: "Qui habite sur la planète Terre ?",
              options: ["Seulement les poissons 🐠", "Les humains, les animaux et les plantes 🧑‍🤝‍🧑🐶🌲", "Personne, elle est vide 🌌"],
          ...
          quiz: [
            {
              ...
              options: ["En Égypte 🇪🇬", "En France 🇫🇷", "Aux États-Unis 🇺🇸"],
              correctAnswer: "En France 🇫🇷"
            },
            {
              question: "Quelle est la forme géométrique des pyramides d'Égypte ?",
              options: ["Toutes rondes comme un ballon 🎈", "Pointues comme des triangles 🔺", "Plates comme une feuille 📄"],
              correctAnswer: "Pointues comme des triangles 🔺"
            },
            {
              question: "Que tient la Statue de la Liberté verte dans sa main ? 🗽",
              options: ["Une torche allumée 🔥", "Un canard en plastique 🦆", "Un téléphone portable 📱"],
          ...
          quiz: [
            {
              ...
              options: ["Le manteau 🔥", "La croûte terrestre 🥾", "Le noyau central ☄️"],
              correctAnswer: "La croûte terrestre 🥾"
            },
            {
              question: "Quelle partie au centre de la Terre est aussi chaude que le Soleil ?",
              options: ["L'océan Pacifique 🌊", "Le manteau rocheux 🗻", "Le noyau en métal ☄️"],
              correctAnswer: "Le noyau en métal ☄️"
            },
            {
              question: "Que se trouve-t-il principalement dans le manteau terrestre ?",
              options: ["De l'eau potable glacée 🧊", "Des roches très chaudes pouvant fondre en magma 🔥", "Des squelettes de dinosaures intacts 🦖"],
            ...
            },
            {
              ...
              options: ["Les plaques tectoniques 🧩", "Les zones sismiques 🌋", "Les courants marins 🌊"],
              correctAnswer: "Les plaques tectoniques 🧩"
            },
            {
              question: "Qu'est-ce qui provoque la formation de grandes chaînes de montagnes ?",
              options: ["Le vent et l'érosion 💨", "La collision lente de deux plaques tectoniques ⛰️", "La chute d'une météorite ☄️"],
          ...
          quiz: [
            {
              ...
              options: ["Chat 🐱", "Sapin 🌲", "Chocolat 🍫"],
              correctAnswer: "Sapin 🌲"
            },
            {
              question: "Quel mot rime avec 'Maison' ? 🏠",
              options: ["Ballon 🎈", "Girafe 🦒", "Grenouille 🐸"],
              correctAnswer: "Ballon 🎈"
            },
            {
              question: "Que se passe-t-il quand deux mots riment ?",
              options: ["Ils s'écrivent pareil 📝", "Ils se terminent par le même son 🎶", "Ils veulent dire le contraire 🚫"],
        ...
        },
        {
          ...
          quiz: [
            ...
            },
            {
              ...
              options: ["son (bruit) 🔊", "sont (verbe être) 😊", "sans 🚫"],
              correctAnswer: "sont (verbe être) 😊"
            },
            {
              question: "Trouve la phrase qui contient une ERREUR d'accord du verbe :",
              options: ["Le singe grimpe vite 🐒", "Les girafes mangent des feuilles 🦒", "Les chats miaule très fort 🐱"],
          ...
          quiz: [
            {
              ...
              options: ["Vert 💚", "Violet 💜", "Rouge 🔴"],
              correctAnswer: "Vert 💚"
            },
            {
              question: "Quel mélange donne la jolie couleur Orange ? 🍊",
              options: ["Bleu + Rouge", "Rouge + Jaune 🔴+🟡", "Vert + Bleu"],
              correctAnswer: "Rouge + Jaune 🔴+🟡"
            },
            {
              question: "Quelles sont les trois couleurs primaires ?",
              options: ["Vert, Orange et Violet", "Bleu, Rouge et Jaune 🔵🔴🟡", "Noir, Blanc et Gris"],
          ...
          quiz: [
            {
              ...
              options: ["Peindre des portraits parfaits de rois 👑", "Capturer la lumière naturelle et l'instant présent ☀️", "Dessiner des formes géométriques abstraites 📐"],
            ...
            },
            {
              ...
              options: ["Leonardo da Vinci 🎨", "Claude Monet 🖼️", "Pablo Picasso 🧑‍🎨"],
              correctAnswer: "Claude Monet 🖼️"
            },
            {
              question: "Quelle invention a permis aux artistes de peindre facilement en plein air ?",
              options: ["L'appareil photo numérique 📷", "Les tubes de peinture souples", "L'électricité portative ⚡"],
              correctAnswer: "Les tubes de peinture souples"
            },
            {
              question: "Qu'est-ce que l'art abstrait ?",
              options: ["De la peinture uniquement avec les doigts 👐", "Une peinture qui n'essaie pas de représenter le monde réel mais exprime des émotions par les formes et couleurs 🎨", "Des sculptures en stone 🗿"],
            ...
            },
            {
              ...
              options: ["Mélanger les couleurs directement sur la toile avec de l'eau 💧", "Poser des petits points de couleurs différentes côte à côte et laisser l'œil faire le mélange de loin 👁️", "Peindre les yeux fermés 🙈"],
          ...
          quiz: [
            {
              ...
              options: ["Le volume 🔊", "Le tempo ⏱️", "La note 🎵"],
            ...
            },
            {
              ...
              options: ["Le cri du chanteur 🎤", "Le battement stable comme le tic-tac d'une horloge ⏱️", "L'instrument le plus fort 🎺"],
            ...
            },
            {
              ...
              options: ["La famille des cordes 🎻", "La famille des vents 🎷", "La famille des percussions 🥁"],
